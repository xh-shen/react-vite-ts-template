/*
 * @Author: shen
 * @Date: 2022-10-24 08:18:47
 * @LastEditors: shen
 * @LastEditTime: 2022-10-24 08:37:11
 * @Description:
 */
...
import type { FC, CSSProperties, ComponentPropsWithoutRef, ReactNode } from 'react'
...
const CountUp: FC<CountUpProps> = props => {
	...
	return (
		<span className={className} ref={containerRef} style={style} {...containerProps}>
