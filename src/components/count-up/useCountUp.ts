/*
 * @Author: shen
 * @Date: 2022-10-24 08:25:19
 * @LastEditors: shen
 * @LastEditTime: 2022-10-24 08:33:01
 * @Description:
 */
...
import createCountUpInstance from './createInstance'
...
const useCountUp = (props: useCountUpProps): CountUpApi => {
	const { ref, startOnMount, enableReinitialize, delay, onEnd, onStart, onPauseResume, onReset, onUpdate, ...instanceProps } =
